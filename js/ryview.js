...
const RV = RyView = {
    ...
    init: (A) => {
        ...
        // test
        //a = RV.E2d = {'#sfsd':{id:'#sfsd', nm:'www', tl:'l', f:1, s:1, x:0, y:0, w:100, h:100, pl:[1,2,3,4,5,6,7,8]}};
        //b = RV.v2t(a);
        //CL(b);
        
        //b = 'E2d id:#sfsd; nm:www; tl:l; f:1; s:1; w:100; h:100; pl:1,2,3,4,5,6,7,8';
        //c = RV.t2v(b);
        //CL(RV.E2d);
        
        //a = new FontFace('kuhei', 'url(font/kuhei.ttf)');
        //a.load().then(a=>CL(a));
        
        //CL(document.styleSheets);
        //RV.t2v('E2d id:#Eico; tl:l; f:1; fs:#f22; s:1; ls:#000; w:20; h:10; pl:0,0, 20,0, 10,0, 10,10');
        //RV.E2d = {'#Eico':{id:'#Eico', tl:'l', s:1, x:0, y:0, w:20, h:10, pl:[0,0, 20,0, 10,0, 10,10]}};
        //a = RV.v2t('E');
        //RV.ren();
        //CL(a);
    ...
    src: { // resources
        ico: {
            des: 'icon',
            '$Isce1': 'E2d tl:g; a:4; f:1; x:2; y:4; w:20; h:4; r:15; fs:hsba(.:.:-25:.).. tl:g; a:4; f:1; x:2; y:10; w:20; h:12; fs:hsba(.:.:-25:.)',
            '$Isce2': 'E2d tl:g; a:4; f:1; x:2; y:4; w:20; h:4; r:15; fs:hsba(.:.:-5:.).. tl:g; a:4; f:1; x:2; y:10; w:20; h:12; fs:hsba(.:.:-5:.)',
            '$Isce3': 'E2d tl:g; a:4; f:1; x:2; y:4; w:20; h:4; r:15; fs:hsba(.:.:-15:.).. tl:g; a:4; f:1; x:2; y:10; w:20; h:12; fs:hsba(.:.:-15:.)',
            
            '$Ispr1': 'E2d tl:l; f:1; x:2; y:2; w:20; h:20; fs:#fff; pl:12,12, 22,5, 22,19, 12,12.. tl:g; a:0; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-25:.); n:s1.. tl:g; a:0; f:1; x:8; y:4; w:5; h:5; fs:#fff; n:d',
            '$Ispr2': 'E2d tl:l; f:1; x:2; y:2; w:20; h:20; fs:#fff; pl:12,12, 22,5, 22,19, 12,12.. tl:g; a:0; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-5:.); n:s1.. tl:g; a:0; f:1; x:8; y:4; w:5; h:5; fs:#fff; n:d',
            '$Ispr3': 'E2d tl:l; f:1; x:2; y:2; w:20; h:20; fs:#fff; pl:12,12, 22,5, 22,19, 12,12.. tl:g; a:0; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-15:.); n:s1.. tl:g; a:0; f:1; x:8; y:4; w:5; h:5; fs:#fff; n:d',
            
            '$Iado1': 'E2d tl:g; a:4; f:1; x:2; y:9; w:8; h:6; fs:hsba(.:.:-25:.).. tl:g; a:3; f:1; x:2; y:3; w:14; h:18; r:180; fs:hsba(.:.:-25:.).. tl:l; x:2; y:3; w:24; h:24; s:1; lw:2; lc:r; ls:hsba(.:.:-25:.); pl:18,9, 21,5, =,=, 18,12, 21,12, =,=, 18,15, 21,19',
            '$Iado2': 'E2d tl:g; a:4; f:1; x:2; y:9; w:8; h:6; fs:hsba(.:.:-5:.).. tl:g; a:3; f:1; x:2; y:3; w:14; h:18; r:180; fs:hsba(.:.:-5:.).. tl:l; x:2; y:3; w:24; h:24; s:1; lw:2; lc:r; ls:hsba(.:.:-5:.); pl:18,9, 21,5, =,=, 18,12, 21,12, =,=, 18,15, 21,19',
            '$Iado3': 'E2d tl:g; a:4; f:1; x:2; y:9; w:8; h:6; fs:hsba(.:.:-15:.).. tl:g; a:3; f:1; x:2; y:3; w:14; h:18; r:180; fs:hsba(.:.:-15:.).. tl:l; x:2; y:3; w:24; h:24; s:1; lw:2; lc:r; ls:hsba(.:.:-15:.); pl:18,9, 21,5, =,=, 18,12, 21,12, =,=, 18,15, 21,19',
            
            '$Idt1': 'E2d tl:l; s:1; lw:3; lc:r; x:2; y:2; w:24; h:24; ls:hsba(.:.:-25:.); pl:4,15, 4,20, =,=, 9,10, 9,20, =,=, 14,12, 14,20, =,=, 19,8, 19,20, =,=, 4,11, 9,6, 14,8, 19,4',
            '$Idt2': 'E2d tl:l; s:1; lw:3; lc:r; x:2; y:2; w:24; h:24; ls:hsba(.:.:-5:.); pl:4,15, 4,20, =,=, 9,10, 9,20, =,=, 14,12, 14,20, =,=, 19,8, 19,20, =,=, 4,11, 9,6, 14,8, 19,4',
            '$Idt3': 'E2d tl:l; s:1; lw:3; lc:r; x:2; y:2; w:24; h:24; ls:hsba(.:.:-15:.); pl:4,15, 4,20, =,=, 9,10, 9,20, =,=, 14,12, 14,20, =,=, 19,8, 19,20, =,=, 4,11, 9,6, 14,8, 19,4',
            
            '$Idia1': 'E2d tl:g; a:4; f:1; x:2; y:2; w:20; h:16; fs:hsba(.:.:-25:.).. tl:l; f:1; x:2; y:2; w:24; h:24; fs:hsba(.:.:-25:.); pl:8,16, 16,16, 20,22, 8,16;.. tl:l; s:1; lw:2; lc:r; x:2; y:2; w:24; h:24; ls:#fff; n:d; pl:4,5, 10,5, =,=, 9,10, 15,10, =,=, 14,15, 20,15',
            '$Idia2': 'E2d tl:g; a:4; f:1; x:2; y:2; w:20; h:16; fs:hsba(.:.:-5:.).. tl:l; f:1; x:2; y:2; w:24; h:24; fs:hsba(.:.:-5:.); pl:8,16, 16,16, 20,22, 8,16;.. tl:l; s:1; lw:2; lc:r; x:2; y:2; w:24; h:24; ls:#fff; n:d; pl:4,5, 10,5, =,=, 9,10, 15,10, =,=, 14,15, 20,15',
            '$Idia3': 'E2d tl:g; a:4; f:1; x:2; y:2; w:20; h:16; fs:hsba(.:.:-15:.).. tl:l; f:1; x:2; y:2; w:24; h:24; fs:hsba(.:.:-15:.); pl:8,16, 16,16, 20,22, 8,16;.. tl:l; s:1; lw:2; lc:r; x:2; y:2; w:24; h:24; ls:#fff; n:d; pl:4,5, 10,5, =,=, 9,10, 15,10, =,=, 14,15, 20,15',
            
            '$Ist1': 'E2d tl:g; a:3; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-25:.)',
            '$Ist2': 'E2d tl:g; a:3; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-5:.)',
            '$Ist3': 'E2d tl:g; a:3; f:1; x:2; y:2; w:20; h:20; fs:hsba(.:.:-15:.)',
            
            '$Ires1': 'E2d tl:g; a:4; f:1; x:4; y:4; w:6; h:16; fs:hsba(.:.:-25:.).. tl:g; a:4; f:1; x:14; y:4; w:6; h:16; fs:hsba(.:.:-25:.)',
            '$Ires2': 'E2d tl:g; a:4; f:1; x:4; y:4; w:6; h:16; fs:hsba(.:.:-5:.).. tl:g; a:4; f:1; x:14; y:4; w:6; h:16; fs:hsba(.:.:-5:.)',
            '$Ires3': 'E2d tl:g; a:4; f:1; x:4; y:4; w:6; h:16; fs:hsba(.:.:-15:.).. tl:g; a:4; f:1; x:14; y:4; w:6; h:16; fs:hsba(.:.:-15:.)',
            
            '$Isp1': 'E2d tl:g; a:4; f:1; x:4; y:4; w:16; h:16; fs:hsba(.:.:-25:.)',
            '$Isp2': 'E2d tl:g; a:4; f:1; x:4; y:4; w:16; h:16; fs:hsba(.:.:-5:.)',
            '$Isp3': 'E2d tl:g; a:4; f:1; x:4; y:4; w:16; h:16; fs:hsba(.:.:-15:.)',
            
            '$Iori1': 'E2d tl:g; f:1; s:0; x:2; y:2; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori2': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:9.5; y:2; w:4; h:4; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori3': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:17; y:2; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori4': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:2; y:9.5; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori5': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:9.5; y:9.5; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori6': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:17; y:9.5; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori7': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:2; y:17; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori8': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:9.5; y:17; w:5; h:5; a:4; fs:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);',
            
            '$Iori9': 'E2d tl:g; f:0; s:1; x:2; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:2; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:17; y:9.5; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:2; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:0; s:1; x:9.5; y:17; w:4; h:4; a:4; ls:hsba(.:.:-25:.);.. tl:g; f:1; s:0; x:17; y:17; w:5; h:5; a:4; fs:hsba(.:.:-25:.);',
            
            '$Iali1': 'E2d tl:g; f:1; x:2; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:6; y:4; w:10; h:7; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:6; y:13; w:14; h:7; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali2': 'E2d tl:g; f:1; x:11; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:7; y:4; w:10; h:7; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:5; y:13; w:14; h:7; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali3': 'E2d tl:g; f:1; x:20; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:8; y:4; w:10; h:7; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:4; y:13; w:14; h:7; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali4': 'E2d tl:g; f:1; x:2; y:2; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:4; y:6; w:7; h:10; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:13; y:6; w:7; h:14; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali5': 'E2d tl:g; f:1; x:2; y:11; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:4; y:7; w:7; h:10; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:13; y:5; w:7; h:14; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali6': 'E2d tl:g; f:1; x:2; y:20; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:4; y:8; w:7; h:10; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:13; y:4; w:7; h:14; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali7': 'E2d tl:g; f:1; x:2; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:4; y:5; w:6; h:14; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:14; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:16; y:7; w:6; h:10; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali8': 'E2d tl:g; f:1; x:5; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:3; y:5; w:6; h:14; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:17; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:15; y:7; w:6; h:10; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali9': 'E2d tl:g; f:1; x:8; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:2; y:7; w:6; h:10; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:20; y:2; w:2; h:20; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:14; y:5; w:6; h:14; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali10': 'E2d tl:g; f:1; x:2; y:2; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:5; y:4; w:14; h:6; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:2; y:14; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:7; y:16; w:10; h:6; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali11': 'E2d tl:g; f:1; x:2; y:4; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:7; y:2; w:10; h:6; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:2; y:18; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:5; y:16; w:14; h:6; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iali12': 'E2d tl:g; f:1; x:2; y:8; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:7; y:2; w:10; h:6; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:2; y:20; w:20; h:2; a:4; fs:hsba(.:.:-25:.).. tl:g; f:1; x:5; y:14; w:14; h:6; a:4; fs:hsba(.:.:-25:.)',
            
            '$Iisf1': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.);.. tl:g; a:4; f:1; x:4; y:6; w:16; h:5; fs:hsba(+10:+10:+25:.);.. tl:g; a:4; f:1; x:4; y:11; w:16; h:5; fs:hsba(+20:+20:.:.);.. tl:g; a:4; f:1; x:4; y:16; w:16; h:5; fs:hsba(+30:+30:-25:.)',
            '$Iisf2': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.);.. tl:g; a:4; f:1; x:4; y:6; w:16; h:5; fs:hsba(+10:+10:+25:.);.. tl:g; a:4; f:1; x:4; y:11; w:16; h:5; fs:hsba(+20:+20:.:.);.. tl:g; a:4; f:1; x:4; y:16; w:16; h:5; fs:hsba(+30:+30:-25:.)',
            '$Iisf3': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.);.. tl:g; a:4; f:1; x:4; y:6; w:16; h:5; fs:hsba(+10:+10:+25:.);.. tl:g; a:4; f:1; x:4; y:11; w:16; h:5; fs:hsba(+20:+20:.:.);.. tl:g; a:4; f:1; x:4; y:16; w:16; h:5; fs:hsba(+30:+30:-25:.)',
            '$Iisf4': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.);.. tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-45:.); pl:5,20, 20,3.. tl:g; a:4; f:1; x:4; y:6; w:16; h:5; fs:hsba(+10:+10:+25:.);.. tl:g; a:4; f:1; x:4; y:11; w:16; h:5; fs:hsba(+20:+20:.:.);.. tl:g; a:4; f:1; x:4; y:16; w:16; h:5; fs:hsba(+30:+30:-25:.)',
            
            '$Iiss1': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.)',
            '$Iiss2': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.)',
            '$Iiss3': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.)',
            '$Iiss4': 'E2d tl:g; a:4; s:1; x:3; y:2; w:18; h:20; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.).. tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:5,20, 20,3',
            
            '$Iisp1': 'E2d tl:p; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:4,4, 20,7, 4,17, 20,20.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.)',
            '$Iisp2': 'E2d tl:p; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:4,4, 20,7, 4,17, 20,20.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-5:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-5:.)',
            '$Iisp3': 'E2d tl:p; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:4,4, 20,7, 4,17, 20,20.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-15:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-15:.)',
            '$Iisp4': 'E2d tl:p; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:4,4, 20,7, 4,17, 20,20.. tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:5,20, 20,3.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.)',
            
            '$Iisc1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:4,4, 20,4, 20,20, 4,20, 12,8.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:2; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.)',
            '$Iisc2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:4,4, 20,4, 20,20, 4,20, 12,8.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-5:.).. tl:g; a:4; x:18; y:2; w:4; h:4; f:1; fs:hsba(.:.:-5:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-5:.).. tl:g; a:4; x:2; y:18; w:4; h:4; f:1; fs:hsba(.:.:-5:.)',
            '$Iisc3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:4,4, 20,4, 20,20, 4,20, 12,8.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-15:.).. tl:g; a:4; x:18; y:2; w:4; h:4; f:1; fs:hsba(.:.:-15:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-15:.).. tl:g; a:4; x:2; y:18; w:4; h:4; f:1; fs:hsba(.:.:-15:.)',
            '$Iisc4': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:4,4, 20,4, 20,20, 4,20, 4,4.. tl:g; a:4; x:2; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:2; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:18; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.).. tl:g; a:4; x:2; y:18; w:4; h:4; f:1; fs:hsba(.:.:-25:.)',
            
            '$Iup1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18',
            '$Iup2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsbahsba(.:.:-5:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18',
            '$Iup3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18',
            
            '$Idn1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6',
            '$Idn2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6',
            '$Idn3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6',
            
            '$Itop1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18, =,=, 3,4, 21,4',
            '$Itop2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18, =,=, 3,4, 21,4',
            '$Itop3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:3,12, 11.5,6, 21,12, 11.5,6, 11.5,18, =,=, 3,4, 21,4',
            
            '$Ibot1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6, =,=, 3,20, 21,20',
            '$Ibot2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6, =,=, 3,20, 21,20',
            '$Ibot3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:3,12, 11.5,18, 21,12, 11.5,18, 11.5,6, =,=, 3,20, 21,20',
            
            '$Ihide1': 'E2d id:$Ihide1; nm:隐藏; tl:g; x:3; y:5.5; w:18; h:12; f:0; s:1; ls:hsba(.:.:-25:.); lw:2; lc:r; a:2.. tl:g; a:0; x:9; y:8.5; w:6; h:6; f:1; fs:hsba(.:.:-25:.); s:0',
            '$Ihide2': 'E2d id:$Ihide2; nm:隐藏; tl:g; x:3; y:5.5; w:18; h:12; f:0; s:1; ls:hsba(.:.:-5:.); lw:2; lc:r; a:2.. tl:g; a:0; x:9; y:8.5; w:6; h:6; f:1; fs:hsba(.:.:-5:.); s:0',
            '$Ihide3': 'E2d id:$Ihide3; nm:隐藏; tl:g; x:3; y:5.5; w:18; h:12; f:0; s:1; ls:hsba(.:.:-15:.); lw:2; lc:r; a:2.. tl:g; a:0; x:9; y:8.5; w:6; h:6; f:1; fs:hsba(.:.:-15:.); s:0',
            '$Ihide4': 'E2d id:$Ihide4; nm:隐藏; tl:g; x:3; y:5.5; w:18; h:12; f:0; s:1; ls:hsba(.:.:-25:.); lw:2; lc:r; a:2.. tl:g; a:0; x:9; y:8.5; w:6; h:6; f:1; fs:hsba(.:.:-25:.); s:0;.. tl:l; w:24; h:24; s:1; ls:hsba(.:.:-25:.); lw:2; lc:r; pl:4,20, 20,4',
            
            '$Idel1': 'E2d id:$Idel1; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-25:.); lw:2; lc:r; pl:11.8,3, 11.8,5, =,=, 4,5, 20,5, =,=, 7,18, 7,8, 17,8, 17,18, =,=, 4,20, 20,20, =,=, 11.8,11, 11.8,17',
            '$Idel2': 'E2d id:$Idel2; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-5:.); lw:2; lc:r; pl:11.8,3, 11.8,5, =,=, 4,5, 20,5, =,=, 7,18, 7,8, 17,8, 17,18, =,=, 4,20, 20,20, =,=, 11.8,11, 11.8,17',
            '$Idel3': 'E2d id:$Idel3; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-15:.); lw:2; lc:r; pl:11.8,3, 11.8,5, =,=, 4,5, 20,5, =,=, 7,18, 7,8, 17,8, 17,18, =,=, 4,20, 20,20, =,=, 11.8,11, 11.8,17',
            
            '$Iadd1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:3; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:4,11.5, 19,11.5, =,=, 11.5,4, 11.5,19',
            '$Iadd2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:3; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:4,11.5, 19,11.5, =,=, 11.5,4, 11.5,19',
            '$Iadd3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:3; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:4,11.5, 19,11.5, =,=, 11.5,4, 11.5,19',
            
            '$Iatt1': 'E2d id:$Iatt1; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-25:.); lw:3; lc:r; pl:3,5, 21,5, =,=, 3,11.5, 21,11.5, =,=, 3,18, 21,18',
            '$Iatt2': 'E2d id:$Iatt2; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-5:.); lw:3; lc:r; pl:3,5, 21,5, =,=, 3,11.5, 21,11.5, =,=, 3,18, 21,18',
            '$Iatt3': 'E2d id:$Iatt3; nm:属性; tl:l; w:24; h:24; s:1; ls:hsba(.:.:-15:.); lw:3; lc:r; pl:3,5, 21,5, =,=, 3,11.5, 21,11.5, =,=, 3,18, 21,18',
            
            '$Isave1': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-25:.); pl:3,3, 14,3, 21,10, 21,21, 3,21, 3,3.. tl:g; a:4; f:1; x:7; y:14; w:10; h:6; fs:hsba(.:.:-25:.)',
            '$Isave2': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-5:.); pl:3,3, 14,3, 21,10, 21,21, 3,21, 3,3.. tl:g; a:4; f:1; x:7; y:14; w:10; h:6; fs:hsba(.:.:-5:.)',
            '$Isave3': 'E2d tl:l; s:1; x:2; y:2; w:24; h:24; lw:2; lc:r; lj:r; ls:hsba(.:.:-15:.); pl:3,3, 14,3, 21,10, 21,21, 3,21, 3,3.. tl:g; a:4; f:1; x:7; y:14; w:10; h:6; fs:hsba(.:.:-15:.)',
            
        },
        
        pat: {
            des: 'pattern',
            '$Psl_x1': 'E2d id:$Psl_x1; nm:Scan Line X 1px; tl:l; s:1; lw:1; w:10; h:2; pl:0,0, 10,0',
            '$Psl_y1': 'E2d id:$Psl_y1; nm:Scan Line Y 1px; tl:l; s:1; lw:1; w:2; h:10; pl:0,0, 0,10',
            '$Psl_x2': 'E2d id:$Psl_x2; nm:Scan Line X 2px; tl:l; s:1; lw:2; w:10; h:4; pl:0,0, 10,0',
            '$Psl_y2': 'E2d id:$Psl_y2; nm:Scan Line Y 2px; tl:l; s:1; lw:2; w:4; h:10; pl:0,0, 0,10',
            '$Psl_xy': 'E2d id:$Psl_xy; nm:Scan Line XY; tl:l; s:1; lw:1; w:5; h:5; pl:0,0, 5,5',
            '$Psl_yx': 'E2d id:$Psl_yx; nm:Scan Line YX; tl:l; s:1; lw:1;  w:5; h:5; pl:5,0, 0,5',
            '$Pcb': 'E2d id:$Pcb; nm:Checkerboard; tl:l; f:1; s:0; fs:#000; w:10; h:10; pl:0,0, 5,0, 5,5, 10,5, 10,10, 5,10, 5,5, 0,5, 0,0',
        },
    },
    ...
    ntl: (A) => { // new time line
        var l,s;
        l = RV.lg[RV.LG];
        s = '<div id="rvTLt"><div id="rvTLtl"><div class="rvTLbtn rvTL_sce_1" title="'+(l.sce||'场景(Scenes)')+'"></div><div class="rvTLbtn rvTL_spr_1" title="'+(l.spr||'精灵(Sprite)')+'"></div><div class="rvTLbtn rvTL_ado_1" title="'+(l.ado||'音频(Audio)')+'"></div><div class="rvTLbtn rvTL_dt_1" title="'+(l.dt||'数据(Data)')+'"></div><div class="rvTLbtn rvTL_dia_1" title="'+(l.dia||'台词(Dialog)')+'"></div></div><div id="rvTLtr"><div id="rvTLbtnB"><div id="rvTLbtnSt" class="rvTLbtn rvTL_st_1" title="'+(l.st||'播放(Start)')+'"></div><div id="rvTLbtnSp" class="rvTLbtn rvTL_sp_1" title="'+(l.sp||'停止(Stop)')+'"></div><div id="rvTLTxt" class="rvTLbtn">00:00:00</div></div><div id="rvTLpgB"><div id="rvTLpg1"></div><div id="rvTLpg2"></div><div id="rvTLpg3"></div></div></div></div><div id="rvTLb"></div>';
    ...
    nm: (A) => { // new menu
        ...
        for(z=0; z<s.length; z++) {
            ...
            else if(s[z] == 'hp') f = 'RV.msg(\'帮助(Help)\', RVHELP)';
    ...
    smn: (A) => { // sel menu
        ...
        if(A == 'ds') {
            ...
            t = {ori:'RV.ori()', ali:'if(RV.KO.Ctr) RV.ali();else RV.doali()', isf:'if(RV.KO.Ctr) RV.sea(\'f\',1);else RV.sea(\'f\')', iss:'if(RV.KO.Ctr) RV.sea(\'s\',1);else RV.sea(\'s\')', isp:'if(RV.KO.Ctr) RV.sea(\'p\',1);else RV.sea(\'p\')', isc:'if(RV.KO.Ctr) RV.sea(\'c\',1);else RV.sea(\'c\')', up:'RV.mlay(1)', dn:'RV.mlay(2)', top:'RV.mlay(0)', bot:'RV.mlay(-1)', hide:'RV.sea(\'hd\')', del:'RV.dlay()'}; // , add:'RV.adir()'
            b = [];
            for(z in t) {
                j = '';
    ...
    rw: (A) => { // resize window
        ...
        if(w/h >= 0.75) {
            ...
            o.style.height = l + 'px';
            p.style.width = o.offsetWidth - 124 + 'px';
    ...
    d2d: (A, B, C) => { // draw 2d shape
        ...
        for(z in o) {
            ...
            } else if(q.tl == 'e') { // select
                
                
            } else if(q.tl == 'm') { // move
                
                
            } else if(q.tl == 's') { // scale
                
                
            } else if(q.tl == 'r') { // rotation
                
                
            } else if(q.tl == 'i') { // align
                
                
            } else if(q.tl == 'n') { // boolen
                
                
            } else if(q.tl == 'mi') { // mirror image
                
                
            } else if(q.tl == 'cl') { // clone
    ...
    sa: (A, B) => { // shape attribute
        ...
        if(!o.nm) {
            if(o.tl == 't') o.nm = (l.set.key.a2.t || '文本') + '_' + i;
            else if(o.tl == 'l') o.nm = (l.set.key.a2.l || '直线') + '_' + i;
            else if(o.tl == 'p') o.nm = (l.set.key.a2.p || '路径') + '_' + i;
            else if(o.tl == 'g') o.nm = (l.set.key.a2.g || '多边形') + '('+o.a+')_' + i;
        }
        o = RV.sobj(o, 2);
        //CL(o);
        return o;
        ...
        for(z in o) {
            ...
            if(A=='V' || A=='S' || A=='A') {
                ...
                if(RV.DM == '2d') { // 2d element
                    ...
                    if(o[z].tl) s.push('tl:'+o[z].tl); // tool
                    if(o[z].f==1) s.push('f:'+o[z].f); // is fill:0||1
                    if(o[z].s==1) s.push('s:'+o[z].s); // is stroke:0||1
                    if(o[z].p==1 && o[z].tl=='p') s.push('p:'+o[z].p); // is show path:0||1
                    if(o[z].c==1 && o[z].tl!='g') s.push('c:'+o[z].c); // is closePath:0||1
                    if(o[z].x) s.push('x:'+o[z].x); // X
                    if(o[z].y) s.push('y:'+o[z].y); // Y
                    if(o[z].w) s.push('w:'+o[z].w); // width
                    if(o[z].h) s.push('h:'+o[z].h); // height
                    ...
                    if(o[z].sx) s.push('sx:'+o[z].sx); // shadowOffsetX
                    if(o[z].sy) s.push('sy:'+o[z].sy); // shadowOffsetY
                    ...
                    if(o[z].pl && o[z].pl.length > 0) s.push('pl:'+o[z].pl.join(','));
