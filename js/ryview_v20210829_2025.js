...
const RV = RyView = {
    ...
    init: (A) => {
        ...
        // test
        //a = RV.E2d = {'#sfsd':{id:'#sfsd', nm:'www', t:'l', f:1, s:1, x:0, y:0, w:100, h:100, pl:[1,2,3,4,5,6,7,8]}};
        //b = RV.v2t(a);
        //CL(b);
        
        //b = 'E2d id:#sfsd; nm:www; t:l; f:1; s:1; w:100; h:100; pl:1,2,3,4,5,6,7,8';
        //c = RV.t2v(b);
        //CL(RV.E2d);
        ...
        //RV.t2v('E2d id:#Eico; t:l; f:1; fs:#f22; s:1; ls:#000; w:20; h:10; pl:0,0, 20,0, 10,0, 10,10');
        //RV.E2d = {'#Eico':{id:'#Eico', t:'l', s:1, x:0, y:0, w:20, h:10, pl:[0,0, 20,0, 10,0, 10,10]}};
        //a = RV.v2t('E');
        //RV.ren();
        //CL(a);
